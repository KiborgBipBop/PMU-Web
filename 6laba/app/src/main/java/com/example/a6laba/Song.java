...
public class Song implements Serializable
{
    ...
    public static com.example.a6laba.Song getSongFromJson(JSONObject jo, Context context) throws JSONException
    {
        return new com.example.a6laba.Song(jo.getLong("id"), jo.getString("title"), jo.getInt("albumId"), jo.getString("artistName"), jo.getLong("artistId"),
