...
public class LoginActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mLoadingBar = new ProgressDialog(com.example.a6laba.LoginActivity.this);
        ...
        btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(com.example.a6laba.LoginActivity.this, RegistrationActivity.class));
            }
        });
    }
    ...
    public void buttonClickLoginFb(View v)
    {
        LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>()
        {
            ...
            {
                Toast.makeText(com.example.a6laba.LoginActivity.this, "User cancelled login with Facebook", Toast.LENGTH_SHORT).show();
                updateUI(null);
            }
            ...
            {
                Toast.makeText(com.example.a6laba.LoginActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                updateUI(null);
            }
        });
    }
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>()
        {
            ...
            public void onComplete(@NonNull Task<AuthResult> task)
            {
                if (task.isSuccessful())
                {
                    ...
                    Toast.makeText(com.example.a6laba.LoginActivity.this, user.getEmail() + user.getDisplayName(), Toast.LENGTH_SHORT).show();
                    updateUI(user);
                } else
                {
                    Toast.makeText(com.example.a6laba.LoginActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                    updateUI(null);
                }
            }
        });
