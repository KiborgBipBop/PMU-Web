...
public class Huffman  implements Comparable<Huffman>
{
    ...
    private static class Node
    {
        ...
        public Node(com.example.a6laba.Huffman left, com.example.a6laba.Huffman right)
        {
    ...
    public static com.example.a6laba.Huffman Create(Map<Character, Integer> _charFrequency)
    {
        ...
        for (Map.Entry<Character, Integer> pair : _charFrequency.entrySet())
        {
            ...
            trees.offer(new com.example.a6laba.Huffman(new Node(pair.getValue(), pair.getKey())));
        }
        while (trees.size() > 1)
        {
            com.example.a6laba.Huffman left = trees.poll();
            com.example.a6laba.Huffman right = trees.poll();
            trees.offer(new com.example.a6laba.Huffman(new Node(left, right)));
        }
        return trees.poll();
    }
    ...
    @Override
    public int compareTo(com.example.a6laba.Huffman tree)
    {
