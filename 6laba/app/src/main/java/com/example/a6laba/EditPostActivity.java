...
public class EditPostActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try
        {
            ArrayList<com.example.a6laba.Post> mListPosts = com.example.a6laba.Utility.getPostsList(getApplicationContext());
        ...
        saveBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    post = new com.example.a6laba.Post(selectedImage, imagePostUrl.getText().toString(), descriptionText.getText().toString(),
                    ...
                    try
                    {
                        com.example.a6laba.Utility.savePostInList(getApplicationContext(), post, position);
                    } catch (IOException e)
                    {
                        e.printStackTrace();
