...
{
    private ArrayList<com.example.a6laba.Post> myList;
    ...
    private com.example.a6laba.Song song;
    com.example.a6laba.Post post;
...
//        myList = (ArrayList<Post>) getIntent().getSerializableExtra("data");
        ...
        saveBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    post = new com.example.a6laba.Post(selectedImage, selectedImagePath, descriptionText.getText().toString(), titleText.getText().toString(), linkText.getText().toString(), false, 0.0, "USD");
                    try
                    {
                        com.example.a6laba.Utility.savePostInList(getApplicationContext(), post);
                    } catch (IOException e)
                    {
                        e.printStackTrace();
            ...
            switch (requestCode)
            {
                case (PickMusic):
                    ...
                    Cursor cursor = this.getContentResolver().query(returnedIntent.getData(),
                            com.example.a6laba.Song.projection, null, null, sortOrder);
                    if (cursor != null && cursor.moveToFirst())
                    {
                        do
                        {
                            song = new com.example.a6laba.Song(cursor.getLong(0), cursor.getString(1),
