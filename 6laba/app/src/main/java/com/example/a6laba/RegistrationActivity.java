...
public class RegistrationActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mLoadingBar = new ProgressDialog(com.example.a6laba.RegistrationActivity.this);
        ...
        btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(com.example.a6laba.RegistrationActivity.this, com.example.a6laba.LoginActivity.class));
            }
        });
    }
